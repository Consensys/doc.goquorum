...
```bash title="Example eth_sendTransaction curl HTTP request"
...
```js title="private_tx_web3js_quorum.js"
...
const accountKeyPath = path.resolve(
  __dirname,
  "../../",
  "config/quorum/networkFiles/member1/accountkey",
);
