---
title: Add and remove QBFT validators
...
1.  In the `artifacts` directory, generate one new validator using the [Quorum Genesis Tool](https://www.npmjs.com/package/quorum-genesis-tool):
